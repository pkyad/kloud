app.config(function($stateProvider) {
  $stateProvider.state('businessManagement.articles', {
    url: "/blogs",
    templateUrl: '/static/ngTemplates/app.businessmanagement.blogs.html',
    controller: 'businessManagement.articles'
  }).state('businessManagement.articles.allblogs', {
    url: "/allblogs",
    templateUrl: '/static/ngTemplates/app.businessmanagement.allblogs.html',
    controller: 'businessManagement.articles',
  })
  .state('businessManagement.articles.createblog', {
    url: "/createblog",
    templateUrl: '/static/ngTemplates/app.businessmanagement.blog.form.html',
    controller: 'businessManagement.articles.form',
  })
  .state('businessManagement.articles.editblog', {
    url: "/editblog/:id",
    templateUrl: '/static/ngTemplates/app.businessmanagement.blog.form.html',
    controller: 'businessManagement.articles.form',
  })
