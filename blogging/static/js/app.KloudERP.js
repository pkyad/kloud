...
//   // if ($state.is('businessManagement.blogs')) {
//   //   $state.go('businessManagement.blogs.allblogs')
//   // }
//
//
//   $scope.page = 0;
...
//           var appType = 'articleEditor';
//         } else if (action == 'info') {
//           // $scope.articleData = $scope.data.tableData[i];
//           // $scope.articleContents = $scope.articleData.contents;
//
//           console.log($scope.articleData);
//           console.log($scope.articleContents);
//           var title = 'Details :';
//           var appType = 'articleInfo';
//         }
//
//         $scope.addTab({
...
//           var appType = 'articleEditor';
//         } else if (action == 'info') {
//           $scope.articleData = $scope.data1.tableData[i];
//           $scope.articleContents = $scope.articleData.contents;
//
//           console.log($scope.articleData);
//           console.log($scope.articleContents);
...
//   console.log($state.params, '9843482390409390');
...
//
//   $scope.resetForms();
//   console.log($state.params, "3024903240932909032490390");;
//   if ($state.params == '') {
...
//       console.log(response.data, '490348320482394', 'klk ur heree');
//
//       $scope.sections = $scope.form.contents;
//       console.log($scope.sections, 'asdlasdjfljasldfsdl');
//       console.log($scope.sections);
//       $scope.form.category = "";
//       $scope.form.parent = response.data.category.name;
//
//       var keywords = [];
//       var keywordpush = []
//
...
//     finalData.append('typ__id', d.typ.pk)
//     finalData.append('featuredContent', d.featuredContent)
//     finalData.append('sensitive', d.sensitive)
//
//     if (typeof d.scheduleTime == "object") {
//       finalData.append('scheduleTime', d.scheduleTime.toJSON())
//       console.log(d.scheduleTime, 'aksdlfkldfkl');
//     }
//     finalData.append('tags', tgs)
//     finalData.append('keywords', keywords)
//     finalData.append('metaTitle', d.metaTitle)
//     finalData.append('metaDescription', d.metaDescription)
//
//
...
//     finalData.append('read_time', d.read_time)
...
//     }
//     console.log(otherCategories, 'KLASKLSDFKL');
//     // var toSend = {
//     //   content_type: d.content_type,
//     //   title: d.title,
//     //   articleUrl: d.articleUrl,
//     //   lang: d.lang,
//     //   category__id: $scope.form.otherCategories[0].pk,
//     //   typ__id: d.typ.pk,
//     //   featuredContent: d.featuredContent,
...
//     //   contents__ids: d.articleSections,
//     //   otherCategories__ids: otherCategories,
...
// })
//
// app.controller('controller.createCategory', function($scope, $http, $aside, $state, Flash, $users, $filter,  category) {
//   $scope.form = {
//     name: '',
//     title: '',
//     typ: '',
