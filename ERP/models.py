...
class application(models.Model):
    ...
    windowsStoreUrl = models.TextField(max_length = 500 , null = True )
    macStoreUrl = models.TextField(max_length = 500 , null = True )
    inMenu = models.BooleanField(default = True)
    totalRatings = models.FloatField(null=True , default=4.5)
    richText = models.TextField(null=True)
...
class Division(models.Model):
    ...
    enableWelcome = models.BooleanField(default = False)
    # address
    # themeColor
    # invoiceVersion
