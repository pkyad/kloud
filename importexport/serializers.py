...
class complaintManagementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        'registeredBy',
        'errorCode','status','is_CloseApproved','serviceReportNo','closedBy','attr1','attr2','attr3','division','closedDate','RefurbishedBind',"machineRunning")
    def create(self, validated_data):
    ...
    def update (self, instance, validated_data):
        ...
        'errorCode','status','is_CloseApproved','serviceReportNo','closedBy','attr1','attr2','attr3','closedDate','RefurbishedBind',"machineRunning"]:
            try:
                setattr(instance,key,validated_data[key])
            except:
                pass
