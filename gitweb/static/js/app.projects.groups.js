app.controller('controller.projectManagement.GIT.groups.item' , function($scope ,$http, $users , Flash ){
  // console.log($scope.edit);
  // console.log($scope.delete);
  // console.log($scope.$parent.$parent);
})

app.controller('controller.projectManagement.GIT.groups.modal' , function($scope ,$http, $users , Flash ){
...
app.controller('projectManagement.GIT.groups' , function($scope , $users , Flash ){
