...
app.controller('projectManagement.GIT.manage.profile' , function($scope ,$http, $users , Flash ){
...
app.controller('projectManagement.GIT.manage' , function($scope ,$http, $users , Flash ){
