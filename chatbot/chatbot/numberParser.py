...
def parsePercentage(s):
    ...
    if float(s)>100:
        raise ValueError, 'Percentage can not be more then 100 %r' % e.args[0]

    return float(s)

if __name__ == '__main__':
    print parseNumber("one million two hundred thousand and forty seven")
    print parsePercentage('ten%')
