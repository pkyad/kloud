...
app.controller('businessManagement.clientRelationships.emails' , function($scope , $http , $timeout , $users , $aside , $interval , $window , Flash , $sanitize , $sce , removeHtmlTags , $stateParams , $state, $uibModal){
