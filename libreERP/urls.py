...
urlpatterns = [
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/aboutus', Divisionaboutus , name ='aboutus'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/terms', Divisiontermsofservices , name ='Divisiontermsofservices'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/privacypolicy', Divisionprivacypolicy , name ='Divisionprivacypolicy'),
