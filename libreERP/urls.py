...
urlpatterns = [
    ...
    # url(r'^checkout/(?P<div>[\w|\W]+)', CheckoutView , name ='Checkout'),
    # url(r'^address/(?P<div>[\w|\W]+)', CheckoutAddressView , name ='address'),
    # url(r'^payment/(?P<div>[\w|\W]+)', CheckoutPaymentView , name ='payment'),
    # url(r'^orderSuccessful', OrderSuccessfulView , name ='orderSuccessful'),
    url(r'^orderFailure', OrderFailureView , name ='orderFailure'),
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/orderSuccessful', OrderSuccessfulView , name ='orderSuccessful'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/orderFailure', OrderFailureView , name ='orderFailure'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/details/(?P<id>\d+)', ProductDetails , name ='ProductDetails'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/checkout', CheckoutView , name ='CheckoutView'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/address', CheckoutAddressView , name ='CheckoutAddressView'),
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/read/(?P<blogname>[\w|\W]+)', DivisionblogDetails , name ='DivisionblogDetails'),
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/career/(?P<id>\d+)', careerviewbyDivision , name ='careerviewbyDivision'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/course/(?P<id>\d+)/(?P<urlSuffix>[\w|\W]+)', Divisioncoursedetails , name ='Divisioncoursedetails'),
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/aboutus', Aboutus , name ='aboutus'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/terms', Terms , name ='terms'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/privacypolicy', Privacypolicy , name ='privacypolicy'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/refundpolicy', Refundpolicy , name ='refundpolicy'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/contactus', Contactus , name ='contactus'),
