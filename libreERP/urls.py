...
urlpatterns = [
    ...
    url(r'^pages/(?P<apiKey>[\w|\W]+)/details/(?P<div>[\w|\W]+)/(?P<id>\d+)', ProductDetails , name ='ProductDetails'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/checkout/(?P<div>[\w|\W]+)', CheckoutView , name ='CheckoutView'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/address/(?P<div>[\w|\W]+)', CheckoutAddressView , name ='CheckoutAddressView'),
    url(r'^pages/(?P<apiKey>[\w|\W]+)/payment/(?P<div>[\w|\W]+)', CheckoutPaymentView , name ='CheckoutPaymentView'),
