...
urlpatterns = [
    ...
    url(r'^dataStreamer/', dataStreamer , name = 'dataStreamer'),
    ...
    url(r'^generateExternalOTP/', generateExternalOTPView , name ='generateExternalOTP'), # related to zingoo
    url(r'^verifyExternalOTP/', verifyOTPView , name ='verifyOTP'),# related to zingoo
    url(r'^getDetails/', getDetailsView , name ='getDetails'),# related to zingoo
    ...
    url(r'^createProductOrder/', CreateProductOrderView , name ='createProductOrder'),
    url(r'^updateAddress/', UpdateAddressView , name ='updateAddress'),
    url(r'^createService/', CreateServiceView , name ='createService'),
    url(r'^createContact/', CreateContactView , name ='createContact'),
    url(r'^externalChat/', ExternalChatView , name ='externalChat'),
    url(r'^getAllOrders/', GetAllOrdersView , name ='getAllOrders'),
    url(r'^getAllService/', GetAllServicesView , name ='getAllService'),
    url(r'^externalChatEndPoint/', ExternalChatEndPoint.as_view()),
